...
import { RemoteAvatar, ChatBar, HEADROOM } from "./HubWorld";
...
// none of that station machinery belongs to a room nobody owns - just
// walking around and chatting with whoever else is here right now. Reuses
// HubWorld's own RemoteAvatar/ChatBar/HEADROOM and hubWorld.css wholesale
// (same avatar, same chat bar, same tile grid) rather than duplicating
// them, overriding only the one thing that's actually different: which
// image the room's floor/walls are painted with.
export default function CommonsWorld({ hub, presence, onReturnHome }) {
