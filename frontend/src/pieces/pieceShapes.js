// Raw silhouette path data lifted from react-chessboard's own bundled piece
// set (the standard open-source Cburnett design - same geometry used by
// lichess and many other tools), split into layers so glassPieces.jsx can
// restyle them instead of hand-drawing new (and likely wrong-looking) shapes.
// White and black pieces reuse the same shape data - only the gradient tint
// differs - matching how real glass chess sets use one mold in two colors.
//
// - body: main silhouette, gets the glass gradient fill + rim stroke
// - lines: thin decorative strokes (crosses, belts, slits) kept for
//   recognizability, rendered as a light stroke with no fill
// Small filled details from the original art (eyes, nostrils, crown-ball
// tips) are deliberately dropped for a cleaner, more modern silhouette.
...
export const PIECE_SHAPES = {
  ...
  R: {
    body: [
      ...
      "M 11,14 L 11,9 L 15,9 L 15,11 L 20,11 L 20,9 L 25,9 L 25,11 L 30,11 L 30,9 L 34,9 L 34,14 L 31,17 L 14,17 L 11,14 z",
      "M 31,17 L 31,29.5 L 14,29.5 L 14,17 z",
      "M 31,29.5 L 32.5,32 L 12.5,32 L 14,29.5 z",
    ],
    lines: [],
  },
  N: {
    body: [
      "M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C 9.958,30.06 12.41,27.96 11,28 C 10,28 11.19,29.23 10,30 C 9,30 5.997,31 6,26 C 6,24 12,14 12,14 C 12,14 13.89,12.1 14,10.5 C 13.27,9.506 13.5,8.5 13.5,7.5 C 14.5,6.5 16.5,10 16.5,10 L 18.5,10 C 18.5,10 19.28,8.008 21,7 C 22,7 22,10 22,10 z",
    ],
    lines: [],
  },
  B: {
    ...
    lines: ["M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 22.5,15.5 L 22.5,20.5 M 20,18 L 25,18"],
  },
  Q: {
    body: [
    ...
    lines: ["M 11.5,30 C 15,29 30,29 33.5,30", "M 12,33.5 C 18,32.5 27,32.5 33,33.5"],
  },
  K: {
    body: [
      ...
      "M 12.5,37 C 18,40.5 27,40.5 32.5,37 L 32.5,30 C 32.5,30 41.5,25.5 38.5,19.5 C 34.5,13 25,16 22.5,23.5 L 22.5,27 L 22.5,23.5 C 20,16 10.5,13 6.5,19.5 C 3.5,25.5 12.5,30 12.5,30 L 12.5,37 z",
    ],
    lines: [
